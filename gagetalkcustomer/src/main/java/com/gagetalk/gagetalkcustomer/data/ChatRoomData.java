...
public class ChatRoomData implements Parcelable{
    ...
    public ChatRoomData(String marId, String marName, String cusId, String cusName, String message,
    ...
    public ChatRoomData(Parcel in){
        readFromParcel(in);
    }

    public static final Creator CREATOR = new Creator() {
        @Override
        public ChatRoomData createFromParcel(Parcel source) {
